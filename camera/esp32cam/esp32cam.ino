...
#define WIFI_PASSWD "pastelvase276"
...
bool setupDisplay()
{
    ...
    static FrameCallback frames[] = {
        ...
        [](OLEDDisplay * display, OLEDDisplayUiState * state, int16_t x, int16_t y)
        {
            ...
            display->drawString(64 + x, 0 + y, "Right Button ");
            display->drawString(64 + x, 10 + y, "toggles the screen");
#else
            display->drawString(64 + x, 10 + y, "Right Button ");
            display->drawString(64 + x, 25 + y, "toggles the screen");
#endif
        ...
        */
        [](OLEDDisplay * display, OLEDDisplayUiState * state, int16_t x, int16_t y)
        {
            ...
            display->drawString( 64 + x, 0 + y, "Edge Camera Ready");
            display->drawString(64 + x, 10 + y, "http://" + ipAddress );
            display->drawString(64 + x, 16 + y, mac_address);
            // } else {
#else
            display->drawString( 64 + x, 5 + y, "Edge Camera Ready!");
            display->drawString(64 + x, 25 + y, "http://" + ipAddress );
            display->drawString(64 + x, 45 + y, mac_address);
            // }
    ...
    // delay(50);
    oled.drawString( oled.getWidth() / 2, oled.getHeight() / 2 - 10, "Ready!");
    oled.display();
    ui.setTargetFPS(30);
